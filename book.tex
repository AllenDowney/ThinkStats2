...
error was 0.014.  As {\tt m} increases, we expect the mean error for
$S_{n-1}^2$ to approach 0.
...
about 90\% of the time.  As a result, this interval is called a 90\%
...
gives you a sense of how reliable an estimate
...
We can find an alternative based on the sample median.  Remember
