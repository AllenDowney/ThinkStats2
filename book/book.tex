...
%\begin{figure}
% probability.py
%\centerline{\includegraphics[height=2.5in]{figs/probability_agepreg_hist.pdf}}
%\caption{PMF of mother's age, plotted using Hist (left) and Pmf (right).}
%\label{probability_agepreg_pmf}
%\end{figure}

%Figure~\ref{probability_agepreg_pmf} shows the distribution of mother's
%age, plotted using {\tt thinkplot.Hist} and {\tt thinkplot.Pmf}.
...
% TODO: move this into the next chapter?
...
Something like the class size paradox appears if you survey people
and ask how many children are in their family.  Families with more
children are more likely to appear in your sample.  At the other
extreme, families with no children have no chance to be in the sample.
