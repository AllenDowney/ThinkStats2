...
\item Women born in the 50s married earliest, with successive
  cohorts marrying later and later, at least until age 25 or so.
...
Processes with this property are called ``memoryless,'' because
...
median time until first marriage is about 14 years.  The median falls
until age 22 when the median remaining time is about 7 years.  But
