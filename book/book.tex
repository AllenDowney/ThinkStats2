...
{\tt df} is the DataFrame with pregnancy data.
We return a Series where the index is each caseid, and the values are
a list of indices corresponding to that respondent.
\index{DataFrame}
