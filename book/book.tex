...
The most common application is human lifetimes, but it also
applies to ``survival'' of mechanical and electronic systems,
or the time until any kind of event.
...
estimate, and related statistics, are the product of survival analysis.

The code in this chapter is in {\tt survival.py}.
  For information
about downloading and working with this code, see Section~\ref{code}.
...
Unfortunately, in many real-world scenarios, we can't measure the
distribution of lifetimes or the survival curve directly.  We have
to infer it.
