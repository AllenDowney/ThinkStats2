...
kind of curve to any kind of data.  This use of the term ``regression''
is a historical accident; it is only indirectly related to the
original meaning of the word.

The goal of regression analysis is to describe the relationships
between one set of variables, called the {\bf dependent variables},
and another set of variables, called independent variables or {\bf
  explanatory variables}.

In the previous chapter we used mother's age, the explanatory
variable, to predict birth weight, the dependent variable.  When there
...
are $x_1$, $x_2$, and $x_3$, we would write the following linear
regression model:
%
...
minimize the mean squared value of $\eps$.  This process is called
...
In the previous chapter we used functions in {\tt thinkstats2} to
do simple linear regression.  For multiple regression we are going
to use StatsModels, a Python package that implements several forms
of regression and other analyses.  If you are using Anaconda, you
already have StatsModels; otherwise you might have to install it.
...
units of the estimated parameters {\tt inter} and {\tt slope}?
