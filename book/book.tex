...
\caption{Scatter plot of birth weight and mother's age for 13593 live
births.}
\label{correlate1}
\end{figure}
...
And here's the code that makes a scatter plot of the data:
...
parts of the scatter plot without saturation and making the outliers
