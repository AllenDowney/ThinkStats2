...
non-linear, Pearson's correlation tends to underestimate the strength
...
My solution to this exercises is in \verb"chap13soln.py".
...
depends on it predecessor: if the previous value is {\tt x}, the mean of
