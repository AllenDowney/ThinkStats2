...
def MakeExpoCdf():
    ...
    thinkplot.Save(
        root="analytic_expo_cdf", title="Exponential CDF", xlabel="x", ylabel="CDF"
    )
...
def MakeBabyBoom():
    ...
    thinkplot.Config(xlabel="minutes", ylabel="CCDF", yscale="log", legend=False)
...
def MakeParetoCdf():
    ...
    thinkplot.Save(
        root="analytic_pareto_cdf", title="Pareto CDF", xlabel="x", ylabel="CDF"
    )
...
def MakeNormalCdf():
    ...
    thinkplot.Save(
        root="analytic_normal_cdf", title="Normal CDF", xlabel="x", ylabel="CDF", loc=2
    )
...
def MakeExampleNormalPlot():
    ...
    thinkplot.Save(
        root="analytic_normal_prob_example",
